...
class LoadMetrics:
    ...
    def __init__(self, cam,exp,night):
        ...
        try: #ff
           ...
           print('File not found' ) #for {}, {}, and {}'.format(self.cam, self.exp, self.night) ) #ff
    ...
    #def keys_from_scalars(self, qa_name, params_keys): #f
    ...
    def PARTIALstep_color(self, step_name):
        """ Colors for the wedges in given step in the pipeline
